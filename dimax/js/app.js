    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".testimonials__slider.swiper")) new core(".testimonials__slider.swiper", {
                ...
                pagination: {
                    el: ".testimonials__swiper-pagination.swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".testimonials__swiper-button-prev.swiper-button-prev",
                    nextEl: ".testimonials__swiper-button-next.swiper-button-next"
                },
                on: {}
            });
            if (document.querySelector(".our-partners__slider.swiper")) {
                let partner = document.querySelectorAll(".swiper-slide__body-parnter").length;
                let pagination = document.querySelector(".our-partners__pagination");
                if (partner <= 4) pagination.classList.toggle("--hidden");
                new core(".our-partners__slider.swiper", {
                    ...
                    loop: true,
                    pagination: {
                        el: ".our-partners__pagination.swiper-pagination",
                        clickable: true
                    },
                    breakpoints: {
                        0: {
